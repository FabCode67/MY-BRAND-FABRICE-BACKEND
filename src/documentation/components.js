  ...
  component: {
    schemas: {
      ...
      Contact: {
        ...
        properties: {
          _id: {
            type: "string", // data-type
            description: "Contact identification number", // desc
            example: "ytyVgh", // example of an id
          },
          name: {
            type: "string", // data-type
            description: "Contact's name", // desc
            example: "John Doe", // example of a name
          },
          email: {
            type: "string", // data-type
            description: "Contact's email", // desc
            example: "johndoe@example.com", // example of an email
          },
          message: {
            type: "string", // data-type
            description: "Contact's message", // desc
    ...
    Blog: {
      ...
      properties: {
        _id: {
          type: "string", // data-type
          description: "Blog identification number", // desc
          example: "ytyVgh", // example of an id
        },
        blogTitle: {
          type: "string", // data-type
          description: "Blog's title", // desc
          example: "5 Tips for Writing a Great Blog Post", // example of a title
        },
        blogContent: {
          type: "string", // data-type
          description: "Blog's content", // desc
          example:
            "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.", // example of content
        },
        blogImage: {
          type: "string", // data-type
          description: "Blog's image url", // desc
