...
exports.userSpec = exports.loginSpec = exports.contactSpec = exports.blogSpec = void 0;
...
const loginSpec = swaggerJSDoc(loginOptions);
exports.loginSpec = loginSpec;
const userSpec = swaggerJSDoc(userOption);
exports.userSpec = userSpec;
const contactSpec = swaggerJSDoc(contactOption);
exports.contactSpec = contactSpec;
const blogSpec = swaggerJSDoc(blogOption);
exports.blogSpec = blogSpec;