...
var _default = {
  paths: {
    "/api/user": _objectSpread(_objectSpread({}, postUser), getUser),
    "/api/contact/count": _objectSpread({}, countUser),
    "/api/user/{id}": _objectSpread({}, deleteUser),
    "/api/login": _objectSpread({}, login),
    "/api/profile": _objectSpread({}, profile),
    "/api/contact/": _objectSpread(_objectSpread({}, postContact), getContact),
    "/api/contact/count": _objectSpread({}, countContact),
    "/api/contact/{id}": _objectSpread({}, deleteContact),
    "/api/blog/": _objectSpread(_objectSpread({}, createBlog), getAllBlogs),
    "/api/blog/count": _objectSpread({}, numberOfBlog),
    "/api/blog/{id}": _objectSpread(_objectSpread(_objectSpread({}, getSingleBlog), updateBlog), deleteBlog),
    "/api/blog/{id}/comment": _objectSpread({}, addComment),
    "/api/blog/{id}/comment/count": _objectSpread({}, numberOfComment),
    "/api/blog/{blogId}/comment/{commentId}": _objectSpread({}, deleteComment)
  }
};
